 ...
 */
export class Playback extends EventBus {
    constructor(host) {
        super();
    ...
    static play() {
        ...
        if (Playback._notebuffer.length === 0)
            Playback._notebuffer = Playback._sequence.filter(e => e.time >= Playback._currentTime && e.time <= Playback._start + Playback.duration);
...
//# sourceMappingURL=playback-zyklua.js.map